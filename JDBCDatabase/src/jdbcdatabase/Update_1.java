...
public class Update_1 extends javax.swing.JFrame {
    Data obj;
    public Update_1() {
        try {
            this.obj =new Data();
            ...
            Logger.getLogger(Update_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
