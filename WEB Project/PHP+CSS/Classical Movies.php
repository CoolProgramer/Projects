...
<div class="container col-12">
  <?php echo"<img src=$mainimage  style='width:100%; height:325px'>"?>
   <div class="centered col-12" > <h1 style="color:white"><big>Classical Movies</big></h1></div>
</div>	
...
<?php echo"<img src=$secondimage style='width:250px;height:350px'>" ?>
</div>

<div class="div1" style="padding-top:10px; padding-bottom:10px">
<ol start="3">
...
<?php echo"<img src=$thirdimage style='width:250px;height:400px'>" ?>
</div>

<div class="div1" style="padding-bottom:20px">
<ol start="4">
...
<div class="img">
<?php echo"<img src=$fifthimage style='width:250px;height:250px'>" ?>
</div>
