...
$result2=$mysqli->query("SELECT * FROM original2 WHERE id = '7'");
$row2 = $result2->fetch_assoc();
$Diyar_e_Dil_name = $row2["name"];

$result2=$mysqli->query("SELECT * FROM original2 WHERE id = '7'");
$row2 = $result2->fetch_assoc();
$Diyar_e_Dil_content=$row2["content"];

$result2=$mysqli->query("SELECT * FROM original2 WHERE id = '7'");
$row2 = $result2->fetch_assoc();
$Diyar_e_Dil_cast=$row2["casting"];

$result2=$mysqli->query("SELECT * FROM original2 WHERE id = '7'");
$row2 = $result2->fetch_assoc();
$Diyar_e_Dil_img=$row2["images"];


$result3=$mysqli->query("SELECT * FROM original2 WHERE id = '8'");
$row3 = $result3->fetch_assoc();
$Mann_Mayal_name=$row3["name"];

$result3=$mysqli->query("SELECT * FROM original2 WHERE id = '8'");
$row3 = $result3->fetch_assoc();
$Mann_Mayal_content = $row3["content"];

$result3=$mysqli->query("SELECT * FROM original2 WHERE id = '8'");
$row3 = $result3->fetch_assoc();
$Mann_Mayal_cast=$row3["casting"];

$result3=$mysqli->query("SELECT * FROM original2 WHERE id = '8'");
$row3 = $result3->fetch_assoc();
$Mann_Mayal_img=$row3["images"];


$result4=$mysqli->query("SELECT * FROM original2 WHERE id = '9'");
$row4 = $result4->fetch_assoc();
$Udaari_name = $row4["name"];

$result4=$mysqli->query("SELECT * FROM original2 WHERE id = '9'");
$row4 = $result4->fetch_assoc();
$Udaari_content=$row4["content"];

$result4=$mysqli->query("SELECT * FROM original2 WHERE id = '9'");
$row4 = $result4->fetch_assoc();
$Udaari_cast=$row4["casting"];

$result4=$mysqli->query("SELECT * FROM original2 WHERE id = '9'");
$row4 = $result4->fetch_assoc();
$Udaari_img=$row4["images"];

$result5=$mysqli->query("SELECT * FROM original2 WHERE id = '10'");
...
<div class="container col-12">
    ...
    <div class="centered col-12"  > <h1 style="text-align:center; padding-top:120px">Family Dramas</h1>
</div>
</div>
...
<div class="div1">
<ul> 
<h3><li><?php echo"$Diyar_e_Dil_name"?></li></h3>
<p> <?php echo"$Diyar_e_Dil_content"?></p>
<ul>   
 <p><b><big>CAST</big></b></p>
 <?php echo"$Diyar_e_Dil_cast"?>
</ul></div>
<div class="img1" style="padding-top:130px">
<?php echo"<img src=$Diyar_e_Dil_img style='width:250px;height:250px'>"?>
</div>
...
<div class="div1">
<ul>
<h3><li><?php echo"$Mann_Mayal_name"?></li></h3>
<p><?php echo"$Mann_Mayal_content"?></p>
 <ul> 
 	<p><b><big>CAST</big></b></p>
 	<?php echo "$Mann_Mayal_cast"?> 
 </ul>
 </div>
<div class="img1">
	<?php echo"<img src=$Mann_Mayal_img style='width:250px;height:275px'>"?>
</div>
...
<div class="div1">
<ul>
<h3><li><?php echo"$Udaari_name"?></li></h3>
<p><?php echo"$Udaari_content"?></p>
<ul>
<p><b><big>CAST</big></b></p>
<?php echo"$Udaari_cast"?>
</ul>
</div>
<div class="img1">
<?php echo"<img src=$Udaari_img  style='width:300px;height:250px'>"?>
</div>
