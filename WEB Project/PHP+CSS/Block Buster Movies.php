...
$result0=$mysqli->query("Select * from original where id = '8'");
$row0 = $result0->fetch_assoc();
$mainimage = $row0["images"];


$result1=$mysqli->query("Select * from original where id = '9'");
$row1 = $result1->fetch_assoc();
$firstimage = $row1["images"];
$firstcontent= $row1["content"];
$firstheading=$row1["name"];

$result2=$mysqli->query("Select * from original where id = '10'");
$row2 = $result2->fetch_assoc();
$secondimage = $row2["images"];
$secondcontent= $row2["content"];
$secondheading=$row2["name"];

$result3=$mysqli->query("Select * from original where id = '11'");
$row3 = $result3->fetch_assoc();
$thirdimage = $row3["images"];
$thirdcontent= $row3["content"];
$thirdheading=$row3["name"];

$result4=$mysqli->query("Select * from original where id = '12'");
